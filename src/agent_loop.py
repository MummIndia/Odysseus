...
def _build_system_prompt(
    ...
    # browser_navigate returns the page TITLE and a snapshot file reference —
    # never the page text. Observed: asked to open a URL and summarise it, the
    # agent called browser_navigate, saw exit_code=0, reported "the page loaded
    # successfully", and stopped, having read nothing. Say so explicitly.
    if relevant_tools and any(
